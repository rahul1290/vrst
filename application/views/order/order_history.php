                                        			...
                                        			if(count($orders)>0){
                                        			    ...
                                        			    <tr>
														   ...
														   <?php if($this->session->userdata('user_type') == 'admin'){ ?>
															   ...
															   <td><?php echo $order['verified_by'] == '999999' ? 'Admin' : $order['verified_by']; ?></td>
															   <td><?php echo $order['user_type'] == '' ? 'Admin' : $order['user_type']; ?></td>
														   <?php } ?>
                                        			       <td>
																<?php echo date('d/m/Y H:i:s',strtotime($order['created_at'])); ?>
															</td>
															<td>
																<?php echo date('d/m/Y H:i:s',strtotime($order['verified_at']))?>
														   </td>
                                        			       <td>
																<a href="javascript:void(0);" class="view" data-id="<?php echo $order['bill_id']; ?>" alt="Quick View">
																	<span class="bx bx-show-alt"></span>
																</a>
																<a href="<?php echo base_url('Order_ctrl/returnOrder/').$order['bill_id']; ?>" class="view" alt="Quick View">
